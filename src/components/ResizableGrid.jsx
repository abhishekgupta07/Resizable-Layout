...
class Editor1 extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      Grid_5_Dn1:
        parseInt(localStorage.getItem("Grid_5_Dn1")) ||
        (33.3 / 100) * 100 + "%",
      Grid_5_Dn2:
    ...
    return (
      <div> 
        <div className="parentDiv">
          ...
          >
            Set Windows Orientation and View
          </span>
          <div className="xyz">
            {num === 2 ? (
              <Twogrid
                option={option2}
                defaultSizepara={this.state.Grid2_1}
                size={this.state.Grid2_1}
              ...
              <Threegrid
                option={option2}
                defaultSizepara2={this.state.Grid3_1}
                size={this.state.Grid3_1}
                onChangehandler2={(size) => {
                  this.setState({
                    Grid3_1: size,
                  });
                }}
                defaultSizepara={this.state.Grid3_2}
                size2={this.state.Grid3_2}
              ...
              <SplitPane
                split={option1}
                defaultSize={this.state.Grid_4_H}
                size={this.state.Grid_4_H}
                onChange={(size) => {
                  this.setState({
                    Grid_4_H: size,
                  });
              ...
              >
                <Twogrid
                  option={option2}
                  defaultSizepara={this.state.Grid_4_up}
                  size={this.state.Grid_4_up}
                  onChangehandler={(size) => {
                    this.setState({
                      Grid_4_up: size,
                    });
                ...
                <Twogrid
                  option={option2}
                  defaultSizepara={this.state.Grid_4_Dn}
                  size={this.state.Grid_4_Dn}
                  onChangehandler={(size) => {
                    this.setState({
                      Grid_4_Dn: size,
                    });
              ...
              <SplitPane
                split={option1}
                defaultSize={this.state.Grid_5_H}
                size={this.state.Grid_5_H}
                onChange={(size) => {
                  this.setState({
                    Grid_5_H: size,
                  });
              ...
              >
                <Twogrid
                  option={option2}
                  defaultSizepara={this.state.Grid_5_Up1}
                  size={this.state.Grid_5_Up1}
                  onChangehandler={(size) => {
                    this.setState({
                      Grid_5_Up1: size,
                    });
                ...
                <Threegrid
                  option={option2}
                  defaultSizepara2={this.state.Grid_5_Dn1}
                  size={this.state.Grid_5_Dn1}
                  onChangehandler2={(size) => {
                    this.setState({
                      Grid_5_Dn1: size,
                    });
                  }}
                  defaultSizepara={this.state.Grid_5_Dn2}
                  size2={this.state.Grid_5_Dn2}
                  onChangehandler={(size2) => {
                    this.setState({
                      Grid_5_Dn2: size2,
                    });
              ...
              <SplitPane
                split={option1}
                defaultSize={this.state.Grid_6_H}
                size={this.state.Grid_6_H}
                onChange={(size) => {
                  this.setState({
                    Grid_6_H: size,
                  });
              ...
              >
                ...
                <Threegrid
                  ...
                  defaultSizepara={this.state.Grid_6_Dn2}
                  option={option2}
                  minSizeP1={150}
                  maxSizeP1={700}
                  minSizeP12={100}
